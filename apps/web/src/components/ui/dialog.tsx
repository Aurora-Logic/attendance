  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // 100ms was below the threshold where a modal reads as having
          // arrived rather than blinked into place; Emil's band for modals is
          // 200-500ms, and 200 keeps it crisp for an operations tool. Exit is
