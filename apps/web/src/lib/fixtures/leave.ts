...
const LEAVE_REQUESTS: LeaveRequest[] = [
  {
    ...
    approver: { id: 'u-mgr', name: 'R. Iyer' },
  },
  {
    id: 'lr-1038',
    leaveType: { id: 'lt-sl', name: 'Sick Leave' },
    fromDate: '2026-08-03',
    toDate: '2026-08-03',
    totalDays: 0.5,
  ...
  {
    id: 'lr-1031',
    leaveType: { id: 'lt-el', name: 'Earned Leave' },
    fromDate: '2026-07-13',
    toDate: '2026-07-17',
    totalDays: 5,
  ...
  {
    id: 'lr-1022',
    leaveType: { id: 'lt-lwp', name: 'Leave Without Pay' },
    fromDate: '2026-05-26',
    toDate: '2026-05-27',
    totalDays: 2,
