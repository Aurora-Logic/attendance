...
| P-05 | Reports dashboard | Six KPI tiles, sales-by-month, movement, lapse, composition donut, top-5 share radial, top customers ranked, stock-ageing snapshot — every block on a bordered panel, every one a drill-through. Remaining: KPI deltas + granularity switcher on the dashboard itself; rate radials wait on the fill-rate report | Reports | Decided | In progress — most blocks live |
